# Data Source https://www.ccld.dss.ca.gov/carefacilitysearch/DownloadData

# Webpage for families to find local childcare
...
cc1 <-  read_csv(here("data","ChildCareCenters01192025.csv"))
cc2 <- read_csv(here("data","CHILDCAREHOMEmorethan801192025.csv"))
